...
('大数据开发实习生', '上海云舟科技有限公司', '上海', '浦东新区', '8-12K', 8.00, 12.00, '本科', '在校/应届', 'Python,Spark,Hive,SQL', '互联网', 'demo', 'demo://job/001'),
('数据分析师', '杭州数智信息技术有限公司', '杭州', '西湖区', '10-15K', 10.00, 15.00, '本科', '1-3年', 'Python,Pandas,MySQL,ECharts', '数据服务', 'demo', 'demo://job/002'),
('数据仓库工程师', '北京星河数据有限公司', '北京', '海淀区', '15-25K', 15.00, 25.00, '本科', '3-5年', 'Hive,Spark,ETL,Hadoop', '软件服务', 'demo', 'demo://job/003');
```
